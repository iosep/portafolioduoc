...
//usuario    
    ...
    static ArrayList<UsuarioO> usersAdd = new ArrayList<>();
//rol
    ...
    static ArrayList<RolO> roles = new ArrayList<>();
//area
    ...
    static ArrayList<AreaO> areas = new ArrayList<>();
//competencia
    ...
    static ArrayList<CompetenciaO> competencias = new ArrayList<>();
//nivel    
    ...
    static ArrayList<NivelO> niveles = new ArrayList<>();
//
...
//usuarioArea
    static ArrayList<UsuarioAreaO> rUserAreas = new ArrayList<>();
