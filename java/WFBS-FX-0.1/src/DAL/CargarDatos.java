...
public class CargarDatos {
    ...
    public void cargarUsuarios() {
        ...
        user1 = new UsuarioO("15424261-9",
                ...
                "Admin", "", "José", "Oñate", "ono@ono.com", "H", 99887766, fecha);
        user2 = new UsuarioO("12312312-3",
                "77+9Qe+/vUdm77+9X1MQZe+/vV0177+9aGfvv70677+9cu+/ve+/ve+/vT/vv73vv70677+977+9De+/vSQ=,-576102074",
                "Jefa", "", "Jano", "Yáñez", "ono@ono.com", "H", 88776655, fecha);
        user3 = new UsuarioO("11111111-1",
                "77+9Qe+/vUdm77+9X1MQZe+/vV0177+9aGfvv70677+9cu+/ve+/ve+/vT/vv73vv70677+977+9De+/vSQ=,-576102074",
                "Jefa", "", "Amelia", "López", "ono@ono.com", "M", 77665544, fecha);
        user4 = new UsuarioO("13131313-6",
                "77+9Qe+/vUdm77+9X1MQZe+/vV0177+9aGfvv70677+9cu+/ve+/ve+/vT/vv73vv70677+977+9De+/vSQ=,-576102074",
                "Funcionaria", "12312312-3", "Ana", "Zar", "ono@ono.com", "M", 77665544, fecha);
        user5 = new UsuarioO("77777777-7",
                "77+9Qe+/vUdm77+9X1MQZe+/vV0177+9aGfvv70677+9cu+/ve+/ve+/vT/vv73vv70677+977+9De+/vSQ=,-576102074",
                "Funcionaria", "11111111-1", "Thor", "Aven", "ono@ono.com", "H", 77665544, fecha);
