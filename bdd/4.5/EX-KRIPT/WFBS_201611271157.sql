...
Insert into AREA (NOMBRE,SIGLA,DESCRIPCION,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('HOMICIDIOS','HMCD','AREA QUE INVESTIGA HOMICICIOS ',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into AREA (NOMBRE,SIGLA,DESCRIPCION,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('DELITOS SEXUALES','DLSX','AREA QUE INVESTIGA DELITOS SEXUALES ',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into AREA (NOMBRE,SIGLA,DESCRIPCION,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('DELITOS ECONOMICOS','DLEC','AREA QUE INVESTIGA DELITOS ECONOMICOS ',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into AREA (NOMBRE,SIGLA,DESCRIPCION,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('ROBOS','ROBS','AREA QUE INVESTIGA ROBOS',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into AREA (NOMBRE,SIGLA,DESCRIPCION,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('DELITOS CONTRA LA PROPIEDAD INTELECTUAL','DCPI','AREA QUE INVESTIGA DELITOS CONTRA LA PROPIEDAD INTELECTUAL ',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into AREA (NOMBRE,SIGLA,DESCRIPCION,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('UBICACIÓN DE PERSONAS','UPER','AREA QUE INVESTIGA UBICACIÓN DE PERSONAS ',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('LIDERAZGO','COMPETENCIA EN LIDERAZGO','LIDG','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('COGNITIVA','COMPETENCIA EN COGNITIVA','COGT','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('PENSAMIENTO CIENTÍFICO','COMPETENCIA EN PENSAMIENTO CIENTÍFICO','PCIE','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('PERSPICACIA','COMPETENCIA EN PERSPICACIA','PERS','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('ORIENTACIÓN A LAS PERSONAS','COMPETENCIA EN ORIENTACIÓN A LAS PERSONAS','OPER','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('TRABAJO EN EQUIPO','COMPETENCIA EN RABAJO EN EQUIPO','TEQU','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('COMUNICACIÓN','COMPETENCIA EN COMUNICACIÓN','COMU','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('AUTOCONTROL','COMPETENCIA EN AUTOCONTROL','ACTR','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('EVALUACIÓN','COMPETENCIA EN EVALUACIÓN','EVAL','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('ANÁLISIS Y SÍNTESIS','COMPETENCIA EN ANÁLISIS Y SÍNTESIS','ASIN','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('HABILIDAD DESCRIPTIVA','COMPETENCIA EN HABILIDAD DESCRIPTIVA','HDES','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('CONCENTRACIÓN','COMPETENCIA EN CONCENTRACIÓN','CONC','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('ORGANIZACIÓN Y PLANIFICACIÓN','COMPETENCIA EN ORGANIZACIÓN Y PLANIFICACIÓN','OPLA','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('SENTIDO DE URGENCIA','COMPETENCIA EN SENTIDO DE URGENCIA','SURG','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('BÚSQUEDA DE INFORMACIÓN','COMPETENCIA EN BÚSQUEDA DE INFORMACIÓN','BINF','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('COMPROMISO','COMPETENCIA EN COMPROMISO','COMP','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('INTEGRIDAD','COMPETENCIA EN INTEGRIDAD','INTE','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('ORIENTACIÓN A LOS RESULTADOS','COMPETENCIA EN ORIENTACIÓN A LOS RESULTADOS','ORES','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('ORIENTACIÓN AL SERVICIO PÚBLICO','COMPETENCIA EN ORIENTACIÓN AL SERVICIO PÚBLICO','OSER','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('CUMPLE PLAZOS','COMPETENCIA EN CUMPLE PLAZOS','CPLA','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('DILIGENCIAS CON RESULTADOS','COMPETENCIA EN DILIGENCIAS CON RESULTADOS','DRES','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('CONSISTENCIA Y CLARIDAD','COMPETENCIA EN CONSISTENCIA Y CLARIDAD','CYCL','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('CALIDAD DE INFORMES EMITIDOS','COMPETENCIA EN CALIDAD DE INFORMES EMITIDOS','CINF','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('CAPACIDAD CIENTÍFICO TÉCNICA','COMPETENCIA EN CAPACIDAD CIENTÍFICO TÉCNICA','CCTE','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('CUMPLIMIENTO DEL MÉTODO CIENTÍFICO','COMPETENCIA EN CUMPLIMIENTO DEL MÉTODO CIENTÍFICO','CMCI','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA (NOMBRE,DESCRIPCION,SIGLA,N_OPTIMO,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('RESUELVE CASOS EMBLEMÁTICOS','COMPETENCIA EN RESUELVE CASOS EMBLEMÁTICOS','RCEM','5',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into NIVEL (NOTA,NOMBRE,DESCRIPCION,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('5','MUY BIEN','TODAS BUENAS',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into NIVEL (NOTA,NOMBRE,DESCRIPCION,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('4','BIEN','CASI TODAS BUENAS',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into AREA_COMPETENCIA (AREA_ID,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('6','10',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into AREA_COMPETENCIA (AREA_ID,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('6','8',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into AREA_COMPETENCIA (AREA_ID,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('5','10',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),'0');
Insert into AREA_COMPETENCIA (AREA_ID,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('5','8',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),'0');
Insert into COMPETENCIA_NIVEL (COMPETENCIA_ID,NIVEL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('10','1',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA_NIVEL (COMPETENCIA_ID,NIVEL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('8','1',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),'1');
Insert into COMPETENCIA_NIVEL (COMPETENCIA_ID,NIVEL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('10','2',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into COMPETENCIA_NIVEL (COMPETENCIA_ID,NIVEL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('8','2',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),'1');
Insert into OBSERVACION (NIVEL_INF,NIVEL_SUP,MSJ_INF,MSJ_SUP,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('3','4','MSJ INF ANALISIS (3)','MSJ SUP ANALISIS (4)','10',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into OBSERVACION (NIVEL_INF,NIVEL_SUP,MSJ_INF,MSJ_SUP,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('4','5','MSJ INF AUTOCONTROL (4)','MSJ SUP AUTOCONTROL (5)','8',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into PERIODO (INICIO,FINAL,JEFE_PORC,AUTO_PORC,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values (to_date('22/11/16','DD/MM/RR'),to_date('23/11/16','DD/MM/RR'),'70','30',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into PREGUNTA (PREGUNTA,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('PRE 1 ANALISIS','10',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into PREGUNTA (PREGUNTA,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('PRE 1 AUTOCONTROL','8',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into RESPUESTA (RESPUESTA,PUNTOS,PREGUNTA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('RESP 1 PRE 1 ANALISIS (3)','3','1',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into RESPUESTA (RESPUESTA,PUNTOS,PREGUNTA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('RES 2 PRE 1 ANALISIS (4)','4','1',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into RESPUESTA (RESPUESTA,PUNTOS,PREGUNTA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('RES 1 PRE 1 AUTOCONTROL (5)','5','2',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into RESPUESTA (RESPUESTA,PUNTOS,PREGUNTA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('RES 2 PRE 1 AUTOCONTROL (3)','3','2',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into ROL (NOMBRE,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('ADMINISTRADOR',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into ROL (NOMBRE,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('JEFE',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into ROL (NOMBRE,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('FUNCIONARIO',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO (RUT,RUT_JEFE,CLAVE,TOKEN,NOMBRE,APELLIDO,EMAIL,SEXO,FONO,ROL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('14181477-K','1','B329FC4F67E52E03E46636229D2F54BC','1900-01-01','VITORIO','CERDA','VI@TO.IO','M','987654321','1',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO (RUT,RUT_JEFE,CLAVE,TOKEN,NOMBRE,APELLIDO,EMAIL,SEXO,FONO,ROL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('1-9','1','E253099B5AF8812CBDFAC88B859843C1','QDVVFU14WV6X6VCKBC5ET507V','SYSTEM','ADMINISTRATOR','ADMIN@CL','M','987654321','1',to_date('16/10/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO (RUT,RUT_JEFE,CLAVE,TOKEN,NOMBRE,APELLIDO,EMAIL,SEXO,FONO,ROL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('96714870-9','1','67DA3D553DEC806809BCAADAB28D28E3','1900-01-01','COCA','COLA','COCA@CL','F','987654321','2',to_date('16/10/16','DD/MM/RR'),to_date('16/10/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO (RUT,RUT_JEFE,CLAVE,TOKEN,NOMBRE,APELLIDO,EMAIL,SEXO,FONO,ROL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('90413000-1','1','45195C7193BFB6BF45B9BAFB181F9509','74GHGW8LRN34V2BVUGW0PQNNZ','PEPSI','COLA','PEPSI@CL','F','987654321','2',to_date('16/10/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO (RUT,RUT_JEFE,CLAVE,TOKEN,NOMBRE,APELLIDO,EMAIL,SEXO,FONO,ROL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('76390989-1','90413000-1','D6E4D4124625E9E3FEA84CB601E980E8','LWMJZZP03V9LPHREFK6APWR37','NISSAN','CHILE','NISSAN@CL','M','987654321','3',to_date('16/10/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO (RUT,RUT_JEFE,CLAVE,TOKEN,NOMBRE,APELLIDO,EMAIL,SEXO,FONO,ROL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('86740500-3','90413000-1','025B8A02B75E99B8699F1A67AF61C483','XUE7HAPJH4966SPGF490LYDO7','TOYOYA','CHILE','TOYOTA@CL','M','987654321','3',to_date('16/10/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO (RUT,RUT_JEFE,CLAVE,TOKEN,NOMBRE,APELLIDO,EMAIL,SEXO,FONO,ROL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('59040480-2','90413000-1','31C7978A63A3B52ABFA62EA4886DB998','1900-01-01','HYUNDAI','CHILE','HYUNDAI@CL','M','987654321','3',to_date('16/10/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO (RUT,RUT_JEFE,CLAVE,TOKEN,NOMBRE,APELLIDO,EMAIL,SEXO,FONO,ROL_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('96931150-K','90413000-1','B26B4B840918B5D50AF95128F696E900','1900-01-01','KIA','CHILE','KIA@CL','M','987654321','3',to_date('16/10/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO_AREA (USUARIO_ID,AREA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('5','6',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO_AREA (USUARIO_ID,AREA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('6','6',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('01/01/00','DD/MM/RR'),'1');
Insert into USUARIO_AREA (USUARIO_ID,AREA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('7','6',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),'0');
Insert into USUARIO_AREA (USUARIO_ID,AREA_ID,CREADO,MODIFICADO,DESACTIVADO,ACTIVO) values ('7','4',to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),to_date('22/11/16','DD/MM/RR'),'0');
...
PROCEDURE SP_USUARIO_READ_JEFEAREA
(
  p_IDUSUARIO IN USUARIO.ID%TYPE,
  p_TOKEN IN USUARIO.TOKEN%TYPE,
  p_AREAID IN AREA.ID%TYPE  
);
...
PROCEDURE SP_USUARIO_ACTIVA_ID 
(
    p_IDUSUARIO IN USUARIO.ID%TYPE,
    p_TOKEN IN USUARIO.TOKEN%TYPE, 
    p_id IN USUARIO.ID%TYPE
...
total :=0;
  ...
  IF total = 0 THEN
   INSERT
    INTO USUARIO
      (
        RUT,RUT_JEFE,CLAVE,NOMBRE,APELLIDO,EMAIL,SEXO,FONO,ROL_ID,CREADO,MODIFICADO,DESACTIVADO
      )
      VALUES
      (
        rutformateado,p_RUTJEFE,Fn_Hash(p_RUT,p_CLAVE),UPPER(p_NOMBRE),UPPER(p_APELLIDO),UPPER(p_EMAIL),p_SEXO,p_FONO,p_ROLID,SYSDATE,SYSDATE,TO_DATE('01/01/1900','DD/MM/YYYY') 
      )
      RETURNING ID INTO lastid;
      COMMIT;
  END IF;  
...
total :=0;
  ...
  IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
      SELECT COUNT(*) INTO total FROM USUARIO WHERE ID = p_ID;
      SELECT RUT,CLAVE INTO rut,claveg FROM USUARIO WHERE ID = p_ID;
...
lastid:=0;
 ...
 IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    ELSE
        ...
        OPEN l_cursor FOR
        SELECT  * FROM usuario WHERE id = 0;
        APEX_JSON.open_object;
        APEX_JSON.write('usuario', l_cursor);
        APEX_JSON.close_object;  
    END IF;  
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(18475502302680559)
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(18475639706686176)
,p_template_id=>wwv_flow_api.id(18475502302680559)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'PUT'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_USUARIO.SP_USUARIO_ACTIVA_ID',
'(',
'    :idusuario,',
'    :token,',
'    :id',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18475999798690461)
,p_handler_id=>wwv_flow_api.id(18475639706686176)
,p_name=>'id'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18475753644688393)
,p_handler_id=>wwv_flow_api.id(18475639706686176)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18475881225689542)
,p_handler_id=>wwv_flow_api.id(18475639706686176)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12104793353796401)
,p_module_id=>wwv_flow_api.id(5593564122114746)
,p_uri_template=>'json/read_jefe_area'
,p_priority=>0
,p_etag_type=>'HASH'
);
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12104940445799881)
,p_template_id=>wwv_flow_api.id(12104793353796401)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_USUARIO.SP_USUARIO_READ_JEFEAREA',
'        (',
'            :idusuario,',
'            :token,',
'            :areaid',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12105218342802958)
,p_handler_id=>wwv_flow_api.id(12104940445799881)
,p_name=>'areaid'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12105095726800877)
,p_handler_id=>wwv_flow_api.id(12104940445799881)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12105147962802053)
,p_handler_id=>wwv_flow_api.id(12104940445799881)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
create or replace PACKAGE BODY PKG_PREGUNTA AS
  ...
  SELECT COUNT(*) INTO total FROM PREGUNTA WHERE PREGUNTA LIKE UPPER(p_PREGUNTA);
    ...
    IF total = 0 THEN
      INSERT INTO PREGUNTA (PREGUNTA,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO) VALUES (UPPER(p_PREGUNTA),p_COMPETENCIAID,SYSDATE,SYSDATE,TO_DATE('01/01/1900','DD/MM/YYYY'));
      COMMIT;
    END IF; 
   OPEN l_cursor FOR
      SELECT p.id AS ID,
...
,p_name=>'competenciaid'
,p_bind_variable_name=>'competenciaid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
,p_param_type=>'STRING'
);
...
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>'BEGIN PKG_PREGUNTA.SP_PREGUNTA_READ_COMPETENCIA(:idusuario,:token,:competenciaid);END;'
);
wwv_flow_api.create_restful_param(
...
create or replace PACKAGE BODY PKG_OBSERVACION AS
  ...
  BEGIN
   IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 THEN
       UPDATE OBSERVACION SET 
       ACTIVO = 0, 
       DESACTIVADO = SYSDATE WHERE ID = p_id;
       COMMIT;
   OPEN l_cursor FOR
      SELECT o.id AS ID,
             o.NIVEL_INF AS NIVEL_INF,
...
PROCEDURE SP_USUARIO_AREA_ACTIVA_ID 
(
    p_IDUSUARIO IN USUARIO.ID%TYPE,
    p_TOKEN     IN USUARIO.TOKEN%TYPE,
    p_USUARIOID IN USUARIO_AREA.USUARIO_ID%type,
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    IF total = 0 AND (exusuario+exarea) = 2 THEN
        INSERT INTO USUARIO_AREA (USUARIO_ID,AREA_ID,CREADO,MODIFICADO,DESACTIVADO) 
        VALUES (p_USUARIOID,p_AREAID,SYSDATE,SYSDATE,TO_DATE('01/01/1900','DD/MM/YYYY')) 
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(18481603171132289)
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(18481714253136186)
,p_template_id=>wwv_flow_api.id(18481603171132289)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'PUT'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_USUARIO_AREA.SP_USUARIO_AREA_ACTIVA_ID',
'(',
'    :idusuario,',
'    :token,',
'    :usuarioid,',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18482188795139380)
,p_handler_id=>wwv_flow_api.id(18481714253136186)
,p_name=>'areaid'
,p_bind_variable_name=>'areaid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18481800389136966)
,p_handler_id=>wwv_flow_api.id(18481714253136186)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18481938183137768)
,p_handler_id=>wwv_flow_api.id(18481714253136186)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18482048009138628)
,p_handler_id=>wwv_flow_api.id(18481714253136186)
,p_name=>'usuarioid'
...
PROCEDURE SP_AREA_COMPT_ACTIVA_ID 
(
    p_IDUSUARIO IN USUARIO.ID%TYPE,
    p_TOKEN     IN USUARIO.TOKEN%TYPE,
    p_AREAID IN AREA_COMPETENCIA.AREA_ID%type,
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    IF total = 0 AND (excomp+exarea) = 2 THEN
        INSERT INTO AREA_COMPETENCIA (AREA_ID,COMPETENCIA_ID,CREADO,MODIFICADO,DESACTIVADO) 
        VALUES (p_AREAID,p_COMPTID,SYSDATE,SYSDATE,TO_DATE('01/01/1900','DD/MM/YYYY')) 
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(18480121060023577)
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(18480347936107703)
,p_template_id=>wwv_flow_api.id(18480121060023577)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'PUT'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_AREA_COMPETENCIA.SP_AREA_COMPT_ACTIVA_ID',
'(',
'    :idusuario,',
'    :token,',
'    :areaid,',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18480669428110766)
,p_handler_id=>wwv_flow_api.id(18480347936107703)
,p_name=>'areaid'
,p_bind_variable_name=>'areaid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18480745356111726)
,p_handler_id=>wwv_flow_api.id(18480347936107703)
,p_name=>'comptid'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18480490185108619)
,p_handler_id=>wwv_flow_api.id(18480347936107703)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18480540296109790)
,p_handler_id=>wwv_flow_api.id(18480347936107703)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
PROCEDURE SP_COMPT_NIVEL_ACTIVA_ID
(
    p_IDUSUARIO IN USUARIO.ID%TYPE,
    p_TOKEN     IN USUARIO.TOKEN%TYPE,
    p_COMPTID IN COMPETENCIA_NIVEL.COMPETENCIA_ID%type,
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    IF total = 0 AND (excomp+exnivel) = 2 THEN
        INSERT INTO COMPETENCIA_NIVEL (COMPETENCIA_ID,NIVEL_ID,CREADO,MODIFICADO,DESACTIVADO) 
        VALUES (p_COMPTID,p_NIVELID,SYSDATE,SYSDATE,TO_DATE('01/01/1900','DD/MM/YYYY') ) 
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(18480814703115582)
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(18481038973120588)
,p_template_id=>wwv_flow_api.id(18480814703115582)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'PUT'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_COMPETENCIA_NIVEL.SP_COMPT_NIVEL_ACTIVA_ID',
'(',
'    :idusuario,',
'    :token,',
'    :comptid,',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18481340557123236)
,p_handler_id=>wwv_flow_api.id(18481038973120588)
,p_name=>'comptid'
,p_bind_variable_name=>'comptid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18481188349121363)
,p_handler_id=>wwv_flow_api.id(18481038973120588)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18481416997124085)
,p_handler_id=>wwv_flow_api.id(18481038973120588)
,p_name=>'nivelid'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(18481289357122280)
,p_handler_id=>wwv_flow_api.id(18481038973120588)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    IF total = 0  AND expreg = 1 THEN
        INSERT INTO RESPUESTA (RESPUESTA,PUNTOS,PREGUNTA_ID,CREADO,MODIFICADO,DESACTIVADO) 
        VALUES (UPPER(p_RESPUESTA),p_PUNTOS,p_PREGUNTAID,SYSDATE,SYSDATE,TO_DATE('01/01/1900','DD/MM/YYYY')) 
        RETURNING ID INTO lastid;
        COMMIT;
...
--set verify on feedback on define on
--prompt  ...done
create or replace PACKAGE PKG_ENCUESTA 
AS 
PROCEDURE SP_ENCUESTA_CREATE 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_USUARIOID  IN ENCUESTA.USUARIO_ID%TYPE,
    p_EVALUADOID IN ENCUESTA.EVALUADO_ID%TYPE,
    p_PERIODOID  IN ENCUESTA.PERIODO_ID%TYPE
    
);
PROCEDURE SP_ENCUESTA_READ_ALL 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE
...
PROCEDURE SP_ENCUESTA_READ_ID 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_ID         IN ENCUESTA.ID%TYPE
    
);
 
PROCEDURE SP_ENCUESTA_READ_USUARIO 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_USUARIOID  IN ENCUESTA.USUARIO_ID%TYPE
...
PROCEDURE SP_ENCUESTA_READ_PERIODO 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_PERIODOID  IN ENCUESTA.PERIODO_ID%TYPE
...
PROCEDURE SP_ENCUESTA_DELETE_ID 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_ID         IN ENCUESTA.ID%TYPE    
...
END PKG_ENCUESTA;
/
create or replace PACKAGE BODY PKG_ENCUESTA AS
PROCEDURE SP_ENCUESTA_CREATE 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    SELECT COUNT(*) INTO total FROM ENCUESTA WHERE USUARIO_ID = p_USUARIOID AND EVALUADO_ID = p_EVALUADOID AND PERIODO_ID = p_PERIODOID;
    SELECT COUNT(*) INTO exusu FROM USUARIO WHERE ID = p_USUARIOID;
    SELECT COUNT(*) INTO experiodo FROM PERIODO WHERE ID = p_PERIODOID;
    IF total = 0  AND (exusu+experiodo) = 2 THEN
        ...
        e.EVALUADO_ID AS EVALUADO_ID,
        j.nombre AS EVALUADO_NOMBRE,
        e.periodo_id AS PERIODO_ID,
        p.inicio AS PERIODO_INICIO,
        p.final AS PERIODO_FINAL,
        e.creado AS CREADO,
        e.modificado AS MODIFICADO,
        e.desactivado AS DESACTIVADO,
        e.activo AS ACTIVO
        FROM  ENCUESTA e 
        INNER JOIN usuario u
        ON e.usuario_id = u.id
        INNER JOIN usuario j
        ON e.EVALUADO_ID = j.id
        INNER JOIN periodo p
        ON e.periodo_id = p.id
        WHERE e.id = lastid;   
        APEX_JSON.open_object;
        APEX_JSON.write('encuesta', l_cursor);
        APEX_JSON.close_object;
    ELSE
...
BEGIN
total:=0;
SELECT COUNT(*) INTO total FROM ENCUESTA WHERE ID = p_ID;
...
BEGIN
total:=0;
SELECT COUNT(*) INTO total FROM ENCUESTA WHERE USUARIO_ID = p_USUARIOID;
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    IF total = 1 THEN
        OPEN l_cursor FOR
            ...
            INNER JOIN periodo p
            ON e.periodo_id = p.id
            WHERE  e.usuario_id=p_USUARIOID
            ORDER BY e.id;
            APEX_JSON.open_object;
            APEX_JSON.write('encuesta', l_cursor);
            APEX_JSON.close_object; 
...
BEGIN
total:=0;
SELECT COUNT(*) INTO total FROM ENCUESTA WHERE PERIODO_ID = p_PERIODOID;
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    IF total >0 THEN
        OPEN l_cursor FOR
            ...
            INNER JOIN periodo p
            ON e.periodo_id = p.id
            WHERE  e.periodo_id=p_PERIODOID
            ORDER BY e.id;
            APEX_JSON.open_object;
            APEX_JSON.write('encuesta', l_cursor);
            APEX_JSON.close_object; 
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    IF total > 0  AND (exusu+experiodo) = 2 THEN
        ...
        EVALUADO_ID = p_EVALUADOID,
        PERIODO_ID = p_PERIODOID,
        MODIFICADO = SYSDATE
        WHERE ID = p_ID
        RETURNING ID INTO lastid;
        COMMIT;
...
begin
wwv_flow_api.remove_restful_service(
 p_id=>wwv_flow_api.id(9985876803656846)
,p_name=>'encuesta'
);
 
end;
/
--prompt --application/restful_services/encuesta
begin
wwv_flow_api.create_restful_module(
 p_id=>wwv_flow_api.id(9985876803656846)
,p_name=>'encuesta'
,p_uri_prefix=>'encuesta/'
,p_parsing_schema=>'WFBS'
,p_items_per_page=>25
,p_status=>'PUBLISHED'
,p_row_version_number=>1
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12074576017861155)
,p_module_id=>wwv_flow_api.id(9985876803656846)
,p_uri_template=>'json/create'
,p_priority=>0
,p_etag_type=>'HASH'
);
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12074691625870875)
,p_template_id=>wwv_flow_api.id(12074576017861155)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_ENCUESTA.SP_ENCUESTA_CREATE',
'(',
'    :idusuario,',
'    :token,',
'    :usuarioid,',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12075074591875526)
,p_handler_id=>wwv_flow_api.id(12074691625870875)
,p_name=>'evaluadoid'
,p_bind_variable_name=>'evaluadoid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
,p_param_type=>'STRING'
);
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12074735764871877)
,p_handler_id=>wwv_flow_api.id(12074691625870875)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12075200017878608)
,p_handler_id=>wwv_flow_api.id(12074691625870875)
,p_name=>'periodoid'
,p_bind_variable_name=>'periodoid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
,p_param_type=>'STRING'
);
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12074882175872855)
,p_handler_id=>wwv_flow_api.id(12074691625870875)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12074978769873848)
,p_handler_id=>wwv_flow_api.id(12074691625870875)
,p_name=>'usuarioid'
,p_bind_variable_name=>'usuarioid'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12086042175009934)
,p_module_id=>wwv_flow_api.id(9985876803656846)
,p_uri_template=>'json/delete'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12086108895012034)
,p_template_id=>wwv_flow_api.id(12086042175009934)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'DELETE'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_ENCUESTA.SP_ENCUESTA_DELETE_ID',
'(',
'    :idusuario,',
'    :token,',
'    :id',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12086465272015576)
,p_handler_id=>wwv_flow_api.id(12086108895012034)
,p_name=>'id'
,p_bind_variable_name=>'id'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12086207908013686)
,p_handler_id=>wwv_flow_api.id(12086108895012034)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12086341748014625)
,p_handler_id=>wwv_flow_api.id(12086108895012034)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12077576894159200)
,p_module_id=>wwv_flow_api.id(9985876803656846)
,p_uri_template=>'json/read_all'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12077661786162938)
,p_template_id=>wwv_flow_api.id(12077576894159200)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_ENCUESTA.SP_ENCUESTA_READ_ALL',
'(',
'    :idusuario,',
'    :token',
');',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12077771946163860)
,p_handler_id=>wwv_flow_api.id(12077661786162938)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12077886907164779)
,p_handler_id=>wwv_flow_api.id(12077661786162938)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12079257125276731)
,p_module_id=>wwv_flow_api.id(9985876803656846)
,p_uri_template=>'json/read_id'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12079319459279778)
,p_template_id=>wwv_flow_api.id(12079257125276731)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_ENCUESTA.SP_ENCUESTA_READ_ID',
'(',
'    :idusuario,',
'    :token,',
'    :id',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12079679107282774)
,p_handler_id=>wwv_flow_api.id(12079319459279778)
,p_name=>'id'
,p_bind_variable_name=>'id'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12079469410280638)
,p_handler_id=>wwv_flow_api.id(12079319459279778)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12079515456281762)
,p_handler_id=>wwv_flow_api.id(12079319459279778)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12081542568425333)
,p_module_id=>wwv_flow_api.id(9985876803656846)
,p_uri_template=>'json/read_periodo'
,p_priority=>0
,p_etag_type=>'HASH'
);
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12081657572428046)
,p_template_id=>wwv_flow_api.id(12081542568425333)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_ENCUESTA.SP_ENCUESTA_READ_PERIODO',
'(',
'    :idusuario,',
'    :token,',
'    :periodoid',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12081795430429609)
,p_handler_id=>wwv_flow_api.id(12081657572428046)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12081965986431578)
,p_handler_id=>wwv_flow_api.id(12081657572428046)
,p_name=>'periodoid'
,p_bind_variable_name=>'periodoid'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12081892183430598)
,p_handler_id=>wwv_flow_api.id(12081657572428046)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12080734354386738)
,p_module_id=>wwv_flow_api.id(9985876803656846)
,p_uri_template=>'json/read_usuario'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12080894555389621)
,p_template_id=>wwv_flow_api.id(12080734354386738)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_ENCUESTA.SP_ENCUESTA_READ_USUARIO',
'(',
'    :idusuario,',
'    :token,',
'    :usuarioid',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12080965101393297)
,p_handler_id=>wwv_flow_api.id(12080894555389621)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12081081286394691)
,p_handler_id=>wwv_flow_api.id(12080894555389621)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12081113036395563)
,p_handler_id=>wwv_flow_api.id(12080894555389621)
,p_name=>'usuarioid'
,p_bind_variable_name=>'usuarioid'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12084623323923004)
,p_module_id=>wwv_flow_api.id(9985876803656846)
,p_uri_template=>'json/update'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12084734769926494)
,p_template_id=>wwv_flow_api.id(12084623323923004)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'PUT'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_ENCUESTA.SP_ENCUESTA_UPDATE',
'(',
'    :idusuario,',
'    :token,',
'    :id,',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12085285191937503)
,p_handler_id=>wwv_flow_api.id(12084734769926494)
,p_name=>'evaluadoid'
,p_bind_variable_name=>'evaluadoid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12085030552934924)
,p_handler_id=>wwv_flow_api.id(12084734769926494)
,p_name=>'id'
,p_bind_variable_name=>'id'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12084817473933114)
,p_handler_id=>wwv_flow_api.id(12084734769926494)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12085449793939940)
,p_handler_id=>wwv_flow_api.id(12084734769926494)
,p_name=>'periodoid'
,p_bind_variable_name=>'periodoid'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12084951186933962)
,p_handler_id=>wwv_flow_api.id(12084734769926494)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12085181494936096)
,p_handler_id=>wwv_flow_api.id(12084734769926494)
,p_name=>'usuarioid'
,p_bind_variable_name=>'usuarioid'
,p_source_type=>'HEADER'
...
--set verify on feedback on define on
--prompt  ...done
create or replace PACKAGE PKG_SELECCION 
AS 
PROCEDURE SP_SELECCION_CREATE 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_ENCUESTAID  IN SELECCION.ENCUESTA_ID%TYPE,
    p_RESPUESTAID IN SELECCION.RESPUESTA_ID%TYPE
    
);
PROCEDURE SP_SELECCION_READ_ALL 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE
...
PROCEDURE SP_SELECCION_READ_ID 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_ID         IN SELECCION.ID%TYPE
    
);
 
PROCEDURE SP_SELECCION_READ_ENCUESTA 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_ENCUESTAID  IN SELECCION.ENCUESTA_ID%TYPE
...
PROCEDURE SP_SELECCION_DELETE_ID 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_ID         IN SELECCION.ID%TYPE    
...
END PKG_SELECCION;
/
create or replace PACKAGE BODY PKG_SELECCION AS
PROCEDURE SP_SELECCION_CREATE 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    SELECT COUNT(*) INTO total FROM SELECCION WHERE ENCUESTA_ID = p_ENCUESTAID AND RESPUESTA_ID = p_RESPUESTAID;
    SELECT COUNT(*) INTO exencuesta FROM ENCUESTA WHERE ID = p_ENCUESTAID;
    SELECT COUNT(*) INTO exrespuesta FROM RESPUESTA WHERE ID = p_RESPUESTAID;
    IF total = 0  AND (exencuesta+exrespuesta) > 0 THEN
        ...
        ON S.RESPUESTA_ID=R.ID
        INNER JOIN PREGUNTA P
        ON R.PREGUNTA_ID = P.ID
        WHERE S.id = lastid;   
        APEX_JSON.open_object;
        APEX_JSON.write('seleccion', l_cursor);
        APEX_JSON.close_object;
    ELSE
 
        OPEN l_cursor FOR
        SELECT  * FROM SELECCION WHERE id = 0;
        APEX_JSON.open_object;
        APEX_JSON.write('seleccion', l_cursor);
        APEX_JSON.close_object;  
    END IF;  
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    OPEN l_cursor FOR
       SELECT S.ID,
        ...
        INNER JOIN PREGUNTA P
        ON R.PREGUNTA_ID = P.ID
        ORDER BY S.encuesta_id,S.respuesta_id;
        APEX_JSON.open_object;
        APEX_JSON.write('seleccion', l_cursor);
        APEX_JSON.close_object; 
ELSE
...
BEGIN
total:=0;
SELECT COUNT(*) INTO total FROM SELECCION WHERE ID = p_ID;
...
BEGIN
total:=0;
SELECT COUNT(*) INTO total FROM SELECCION WHERE ENCUESTA_ID = p_ENCUESTAID;
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    IF total > 0 THEN
        OPEN l_cursor FOR
            ...
            INNER JOIN PREGUNTA P
            ON R.PREGUNTA_ID = P.ID
            WHERE S.ENCUESTA_ID=p_ENCUESTAID
            ORDER BY S.encuesta_id;
            APEX_JSON.open_object;
            APEX_JSON.write('seleccion', l_cursor);
            APEX_JSON.close_object; 
        ELSE
...
END IF; 
END SP_SELECCION_READ_ENCUESTA;
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    SELECT COUNT(*) INTO exencuesta FROM ENCUESTA WHERE ID = p_ENCUESTAID;
    SELECT COUNT(*) INTO exrespuesta FROM RESPUESTA WHERE ID = p_RESPUESTAID;
    IF total > 0  AND (exencuesta+exrespuesta) = 2 THEN
        UPDATE SELECCION SET
        
            ENCUESTA_ID = p_ENCUESTAID,
            RESPUESTA_ID = p_RESPUESTAID,
            MODIFICADO = SYSDATE
        WHERE id =  p_ID   
        RETURNING ID INTO lastid;
        COMMIT;
...
begin
wwv_flow_api.remove_restful_service(
 p_id=>wwv_flow_api.id(12092273768352851)
,p_name=>'seleccion'
);
 
end;
/
--prompt --application/restful_services/seleccion
begin
wwv_flow_api.create_restful_module(
 p_id=>wwv_flow_api.id(12092273768352851)
,p_name=>'seleccion'
,p_uri_prefix=>'seleccion/'
,p_parsing_schema=>'WFBS'
,p_items_per_page=>25
,p_status=>'PUBLISHED'
,p_row_version_number=>1
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12092396532382692)
,p_module_id=>wwv_flow_api.id(12092273768352851)
,p_uri_template=>'json/create'
,p_priority=>0
,p_etag_type=>'HASH'
);
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12092481747389908)
,p_template_id=>wwv_flow_api.id(12092396532382692)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_SELECCION.SP_SELECCION_CREATE',
'(',
'    :idusuario,',
'    :token,',
'    :encuestaid,',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12092736469394353)
,p_handler_id=>wwv_flow_api.id(12092481747389908)
,p_name=>'encuestaid'
,p_bind_variable_name=>'encuestaid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
,p_param_type=>'STRING'
);
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12092503132392542)
,p_handler_id=>wwv_flow_api.id(12092481747389908)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12092893827395273)
,p_handler_id=>wwv_flow_api.id(12092481747389908)
,p_name=>'respuestaid'
,p_bind_variable_name=>'respuestaid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
,p_param_type=>'STRING'
);
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12092697402393408)
,p_handler_id=>wwv_flow_api.id(12092481747389908)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12099853808926706)
,p_module_id=>wwv_flow_api.id(12092273768352851)
,p_uri_template=>'json/delete'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12099985318929758)
,p_template_id=>wwv_flow_api.id(12099853808926706)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'DELETE'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_SELECCION.SP_SELECCION_DELETE_ID',
'(',
'    :idusuario,',
'    :token,',
'    :id',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12100276811932345)
,p_handler_id=>wwv_flow_api.id(12099985318929758)
,p_name=>'id'
,p_bind_variable_name=>'id'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12100020679930473)
,p_handler_id=>wwv_flow_api.id(12099985318929758)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12100163395931566)
,p_handler_id=>wwv_flow_api.id(12099985318929758)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12096245160550706)
,p_module_id=>wwv_flow_api.id(12092273768352851)
,p_uri_template=>'json/read_all'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12096363485552919)
,p_template_id=>wwv_flow_api.id(12096245160550706)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_SELECCION.SP_SELECCION_READ_ALL',
'(',
'    :idusuario,',
'    :token',
');',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12096424402553984)
,p_handler_id=>wwv_flow_api.id(12096363485552919)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12096504329554904)
,p_handler_id=>wwv_flow_api.id(12096363485552919)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12097415964833170)
,p_module_id=>wwv_flow_api.id(12092273768352851)
,p_uri_template=>'json/read_encuesta'
,p_priority=>0
,p_etag_type=>'HASH'
);
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12097527326835599)
,p_template_id=>wwv_flow_api.id(12097415964833170)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_SELECCION.SP_SELECCION_READ_ENCUESTA',
'(',
'    :idusuario,',
'    :token,',
'    :encuestaid',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12097873864838324)
,p_handler_id=>wwv_flow_api.id(12097527326835599)
,p_name=>'encuestaid'
,p_bind_variable_name=>'encuestaid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12097632955836379)
,p_handler_id=>wwv_flow_api.id(12097527326835599)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12097795656837244)
,p_handler_id=>wwv_flow_api.id(12097527326835599)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12096757108586500)
,p_module_id=>wwv_flow_api.id(12092273768352851)
,p_uri_template=>'json/read_id'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12096807909588875)
,p_template_id=>wwv_flow_api.id(12096757108586500)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_SELECCION.SP_SELECCION_READ_ID',
'(',
'    :idusuario,',
'    :token,',
'    :id',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12097101963608301)
,p_handler_id=>wwv_flow_api.id(12096807909588875)
,p_name=>'id'
,p_bind_variable_name=>'id'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12096908435589772)
,p_handler_id=>wwv_flow_api.id(12096807909588875)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12097071292592624)
,p_handler_id=>wwv_flow_api.id(12096807909588875)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(12098602882884700)
,p_module_id=>wwv_flow_api.id(12092273768352851)
,p_uri_template=>'json/update'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(12098761192887165)
,p_template_id=>wwv_flow_api.id(12098602882884700)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'PUT'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_SELECCION.SP_SELECCION_UPDATE',
'(',
'    :idusuario,',
'    :token,',
'    :id,',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12099151424891372)
,p_handler_id=>wwv_flow_api.id(12098761192887165)
,p_name=>'encuestaid'
,p_bind_variable_name=>'encuestaid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12099045014890166)
,p_handler_id=>wwv_flow_api.id(12098761192887165)
,p_name=>'id'
,p_bind_variable_name=>'id'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12098854496888096)
,p_handler_id=>wwv_flow_api.id(12098761192887165)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12099269833892419)
,p_handler_id=>wwv_flow_api.id(12098761192887165)
,p_name=>'respuestaid'
,p_bind_variable_name=>'respuestaid'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12098910455889159)
,p_handler_id=>wwv_flow_api.id(12098761192887165)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
--set verify on feedback on define on
--prompt  ...done
create or replace PACKAGE PKG_EVALUACION 
AS 
PROCEDURE SP_EVALUACION_CREATE 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_RUT        IN EVALUACION.RUT%TYPE,
    p_RUTJEFE    IN EVALUACION.RUT_JEFE%TYPE,
    p_NOTAAUTO   IN EVALUACION.NOTA_AUTO%TYPE,
    p_NOTAJEFE   IN EVALUACION.NOTA_JEFE%TYPE,
    p_PERIODOID  IN EVALUACION.PERIODO_ID%TYPE,
    p_COMPETENCIAID IN EVALUACION.COMPETENCIA_ID%TYPE
    
);
PROCEDURE SP_EVALUACION_READ_ALL 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE
...
PROCEDURE SP_EVALUACION_READ_ID 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_ID         IN SELECCION.ID%TYPE
...
PROCEDURE SP_EVALUACION_READ_PERIODO 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_PERIODOID  IN EVALUACION.PERIODO_ID%TYPE
...
PROCEDURE SP_EVALUACION_UPDATE 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_ID         IN EVALUACION.ID%TYPE,
    p_RUT        IN EVALUACION.RUT%TYPE,
    p_RUTJEFE    IN EVALUACION.RUT_JEFE%TYPE,
    p_NOTAAUTO   IN EVALUACION.NOTA_AUTO%TYPE,
    p_NOTAJEFE   IN EVALUACION.NOTA_JEFE%TYPE,
...
PROCEDURE SP_EVALUACION_DELETE_ID 
(
    p_IDUSUARIO  IN USUARIO.ID%TYPE,
    p_TOKEN      IN USUARIO.TOKEN%TYPE,
    p_ID         IN SELECCION.ID%TYPE    
...
FUNCTION FN_BRECHA
(
 p_NOTA   IN EVALUACION.NOTA%TYPE,
 p_COMPETENCIAID IN COMPETENCIA.ID%TYPE   
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    RUT = p_RUT AND 
    RUT_JEFE = p_RUTJEFE AND 
    PERIODO_ID = p_PERIODOID AND 
    COMPETENCIA_ID = p_COMPETENCIAID;
    SELECT COUNT(*) INTO exusu FROM USUARIO WHERE RUT = p_RUT;
    SELECT COUNT(*) INTO exjefe FROM USUARIO WHERE RUT = p_RUTJEFE;
    SELECT COUNT(*) INTO experiodo FROM PERIODO WHERE ID = p_PERIODOID;
    SELECT COUNT(*) INTO excomp FROM COMPETENCIA WHERE ID = p_COMPETENCIAID;
    notacrea:= FN_NOTA(p_NOTAAUTO,p_NOTAJEFE,p_PERIODOID);
    brechacrea:= FN_BRECHA(notacrea,p_COMPETENCIAID);
    IF total = 0  AND (exusu+exjefe+experiodo+excomp) = 4 THEN
        ...
        WHERE id = lastid;   
        APEX_JSON.open_object;
        APEX_JSON.write('evaluacion', l_cursor);
        APEX_JSON.close_object;
    ELSE
 
        OPEN l_cursor FOR
        SELECT  * FROM EVALUACION WHERE id = 0;
        APEX_JSON.open_object;
        APEX_JSON.write('evaluacion', l_cursor);
        APEX_JSON.close_object;  
    END IF;  
...
BEGIN
total:=0;
SELECT COUNT(*) INTO total FROM EVALUACION WHERE ID = p_ID;
...
BEGIN
total:=0;
SELECT COUNT(*) INTO total FROM EVALUACION WHERE PERIODO_ID = p_PERIODOID;
...
END IF; 
END SP_EVALUACION_READ_PERIODO;
...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    SELECT COUNT(*) INTO experiodo FROM PERIODO WHERE ID = p_PERIODOID;
    SELECT COUNT(*) INTO excomp FROM COMPETENCIA WHERE ID = p_COMPETENCIAID;
    notaup:= FN_NOTA(p_NOTAAUTO,p_NOTAJEFE,p_PERIODOID);
    brechaup:= FN_BRECHA(notaup,p_COMPETENCIAID);
    IF total = 1  AND (exusu+exjefe+experiodo+excomp) = 4 THEN
        UPDATE EVALUACION SET 
        
            RUT = p_RUT,
            RUT_JEFE = p_RUTJEFE,
            NOTA_AUTO = p_NOTAAUTO,
            NOTA_JEFE = p_NOTAJEFE,
            NOTA = notaup,
            BRECHA = brechaup,
            PERIODO_ID = p_PERIODOID,
            COMPETENCIA_ID = p_COMPETENCIAID,
...
nota number:=0;
BEGIN
SELECT ROUND((((((p_NOTAAUTO*AUTO_PORC)) +  ((p_NOTAJEFE*JEFE_PORC)))/100)),0)  into nota FROM PERIODO WHERE ID = p_PERIODOID;
RETURN nota;
...
brecha number:=0;
BEGIN
SELECT (n_optimo - p_NOTA)into brecha FROM COMPETENCIA WHERE ID = p_COMPETENCIAID;
RETURN brecha;
...
begin
wwv_flow_api.remove_restful_service(
 p_id=>wwv_flow_api.id(14522109321986310)
,p_name=>'evaluacion'
);
 
end;
/
--prompt --application/restful_services/evaluacion
begin
wwv_flow_api.create_restful_module(
 p_id=>wwv_flow_api.id(14522109321986310)
,p_name=>'evaluacion'
,p_uri_prefix=>'evaluacion/'
,p_parsing_schema=>'WFBS'
,p_items_per_page=>25
,p_status=>'PUBLISHED'
,p_row_version_number=>4
);
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(14522266806992705)
,p_module_id=>wwv_flow_api.id(14522109321986310)
,p_uri_template=>'json/create'
,p_priority=>0
,p_etag_type=>'HASH'
);
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(14522343586066796)
,p_template_id=>wwv_flow_api.id(14522266806992705)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN ',
'PKG_EVALUACION.SP_EVALUACION_CREATE',
'(',
'    :idusuario,',
'    :token,',
'    :rut,',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14525405891358858)
,p_handler_id=>wwv_flow_api.id(14522343586066796)
,p_name=>'brecha'
,p_bind_variable_name=>'brecha'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
,p_param_type=>'STRING'
);
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14525612210362454)
,p_handler_id=>wwv_flow_api.id(14522343586066796)
,p_name=>'competenciaid'
,p_bind_variable_name=>'competenciaid'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14524877988347562)
,p_handler_id=>wwv_flow_api.id(14522343586066796)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14525217003355062)
,p_handler_id=>wwv_flow_api.id(14522343586066796)
,p_name=>'notaauto'
,p_bind_variable_name=>'notaauto'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
,p_param_type=>'STRING'
);
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14525345448356051)
,p_handler_id=>wwv_flow_api.id(14522343586066796)
,p_name=>'notajefe'
,p_bind_variable_name=>'notajefe'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
,p_param_type=>'STRING'
);
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14525557260361409)
,p_handler_id=>wwv_flow_api.id(14522343586066796)
,p_name=>'periodoid'
,p_bind_variable_name=>'periodoid'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14525079738349992)
,p_handler_id=>wwv_flow_api.id(14522343586066796)
,p_name=>'rut'
,p_bind_variable_name=>'rut'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14525124229350961)
,p_handler_id=>wwv_flow_api.id(14522343586066796)
,p_name=>'rutjefe'
,p_bind_variable_name=>'rutjefe'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14524954124349036)
,p_handler_id=>wwv_flow_api.id(14522343586066796)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(14531150548288798)
,p_module_id=>wwv_flow_api.id(14522109321986310)
,p_uri_template=>'json/delete'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(14531255922297929)
,p_template_id=>wwv_flow_api.id(14531150548288798)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'DELETE'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN ',
'PKG_EVALUACION.SP_EVALUACION_DELETE_ID',
'(',
'    :idusuario,',
'    :token,',
'    :id',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14531588866302528)
,p_handler_id=>wwv_flow_api.id(14531255922297929)
,p_name=>'id'
,p_bind_variable_name=>'id'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14531310514298807)
,p_handler_id=>wwv_flow_api.id(14531255922297929)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14531497089300952)
,p_handler_id=>wwv_flow_api.id(14531255922297929)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(14528566324121840)
,p_module_id=>wwv_flow_api.id(14522109321986310)
,p_uri_template=>'json/read_all'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(14528656672146187)
,p_template_id=>wwv_flow_api.id(14528566324121840)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN',
'PKG_EVALUACION.SP_EVALUACION_READ_ALL',
'(',
'    :idusuario,',
'    :token',
');',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14528720471153367)
,p_handler_id=>wwv_flow_api.id(14528656672146187)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14528871153154304)
,p_handler_id=>wwv_flow_api.id(14528656672146187)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(14528906332169400)
,p_module_id=>wwv_flow_api.id(14522109321986310)
,p_uri_template=>'json/read_id'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(14529089754176249)
,p_template_id=>wwv_flow_api.id(14528906332169400)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN ',
'PKG_EVALUACION.SP_EVALUACION_READ_ID',
'(',
'    :idusuario,',
'    :token,',
'    :id',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14529350865182978)
,p_handler_id=>wwv_flow_api.id(14529089754176249)
,p_name=>'id'
,p_bind_variable_name=>'id'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14529104701180454)
,p_handler_id=>wwv_flow_api.id(14529089754176249)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14529260698181737)
,p_handler_id=>wwv_flow_api.id(14529089754176249)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(14529417770194286)
,p_module_id=>wwv_flow_api.id(14522109321986310)
,p_uri_template=>'json/read_periodo'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(14529544355197102)
,p_template_id=>wwv_flow_api.id(14529417770194286)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN ',
'PKG_EVALUACION.SP_EVALUACION_READ_PERIODO',
'(',
'    :idusuario,',
'    :token,',
'    :periodoid',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14529666621198563)
,p_handler_id=>wwv_flow_api.id(14529544355197102)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14529899956201366)
,p_handler_id=>wwv_flow_api.id(14529544355197102)
,p_name=>'periodoid'
,p_bind_variable_name=>'periodoid'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14529764386199882)
,p_handler_id=>wwv_flow_api.id(14529544355197102)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(14529921694230491)
,p_module_id=>wwv_flow_api.id(14522109321986310)
,p_uri_template=>'json/update'
,p_priority=>0
,p_etag_type=>'HASH'
...
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(14530084080234214)
,p_template_id=>wwv_flow_api.id(14529921694230491)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'PUT'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN ',
'PKG_EVALUACION.SP_EVALUACION_UPDATE',
'(',
'    :idusuario,',
'    :token,',
'    :id,',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14531006732261752)
,p_handler_id=>wwv_flow_api.id(14530084080234214)
,p_name=>'competenciaid'
,p_bind_variable_name=>'competenciaid'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14530313339249536)
,p_handler_id=>wwv_flow_api.id(14530084080234214)
,p_name=>'id'
,p_bind_variable_name=>'id'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14530137673246302)
,p_handler_id=>wwv_flow_api.id(14530084080234214)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14530613768254128)
,p_handler_id=>wwv_flow_api.id(14530084080234214)
,p_name=>'notaauto'
,p_bind_variable_name=>'notaauto'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14530758770255866)
,p_handler_id=>wwv_flow_api.id(14530084080234214)
,p_name=>'notajefe'
,p_bind_variable_name=>'notajefe'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14530941401258506)
,p_handler_id=>wwv_flow_api.id(14530084080234214)
,p_name=>'periodoid'
,p_bind_variable_name=>'periodoid'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14530400589251057)
,p_handler_id=>wwv_flow_api.id(14530084080234214)
,p_name=>'rut'
,p_bind_variable_name=>'rut'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14530569174252660)
,p_handler_id=>wwv_flow_api.id(14530084080234214)
,p_name=>'rutjefe'
,p_bind_variable_name=>'rutjefe'
,p_source_type=>'HEADER'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(14530224111248259)
,p_handler_id=>wwv_flow_api.id(14530084080234214)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
...
create or replace PACKAGE PKG_AUDIT_LOG AS 
 PROCEDURE SP_AUDIT_LOG_CREATE
(
    p_IDUSUARIO IN USUARIO.ID%TYPE,
    p_TOKEN     IN USUARIO.TOKEN%TYPE,
    p_IP        IN AUDIT_LOG.IP%TYPE
);
...
BEGIN
    ...
    IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
        ...
        SELECT COUNT(*) INTO total FROM AUDIT_LOG WHERE IP = p_IP AND CREADO = SYSDATE;
        IF total = 0   THEN
            ...
            WHERE AL.id = lastid;   
            APEX_JSON.open_object;
            APEX_JSON.write('audit_log', l_cursor);
            APEX_JSON.close_object;
        ELSE
 
            OPEN l_cursor FOR
            SELECT  * FROM AUDIT_LOG WHERE id = 0;
            APEX_JSON.open_object;
            APEX_JSON.write('audit_log', l_cursor);
            APEX_JSON.close_object;  
        END IF;  
...
begin
wwv_flow_api.remove_restful_service(
 p_id=>wwv_flow_api.id(23356757810075017)
,p_name=>'audit_log'
);
 
end;
/
--prompt --application/restful_services/audit_log
begin
wwv_flow_api.create_restful_module(
 p_id=>wwv_flow_api.id(23356757810075017)
,p_name=>'audit_log'
,p_uri_prefix=>'audit_log/'
,p_parsing_schema=>'WFBS'
,p_items_per_page=>25
,p_status=>'PUBLISHED'
,p_row_version_number=>6
...
wwv_flow_api.create_restful_template(
 p_id=>wwv_flow_api.id(23356831235078885)
,p_module_id=>wwv_flow_api.id(23356757810075017)
,p_uri_template=>'json/create'
,p_priority=>0
,p_etag_type=>'HASH'
);
wwv_flow_api.create_restful_handler(
 p_id=>wwv_flow_api.id(23356982654084214)
,p_template_id=>wwv_flow_api.id(23356831235078885)
,p_source_type=>'PLSQL'
,p_format=>'DEFAULT'
,p_method=>'POST'
,p_require_https=>'NO'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BEGIN PKG_AUDIT_LOG.SP_AUDIT_LOG_CREATE',
'(',
'    :idusuario,',
'    :token,',
'    :ip',
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(23357045664085106)
,p_handler_id=>wwv_flow_api.id(23356982654084214)
,p_name=>'idusuario'
,p_bind_variable_name=>'idusuario'
,p_source_type=>'HEADER'
,p_access_method=>'IN'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(23357220538086991)
,p_handler_id=>wwv_flow_api.id(23356982654084214)
,p_name=>'ip'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(23357125868086082)
,p_handler_id=>wwv_flow_api.id(23356982654084214)
,p_name=>'token'
,p_bind_variable_name=>'token'
,p_source_type=>'HEADER'
