...
ALTER TABLE encuesta_asignada ADD CONSTRAINT usuario_encuesta_PK PRIMARY KEY ( id ) ;
...
ALTER TABLE usuario_encuesta_detalle ADD CONSTRAINT detalle_usuario_encuesta_FK FOREIGN KEY ( asignada_id ) REFERENCES encuesta_asignada ( id ) ;
...
ALTER TABLE usuario_encuesta_detalle ADD CONSTRAINT encuesta_detalle_respuesta_FK FOREIGN KEY ( respuesta_id ) REFERENCES respuesta ( id ) ;

ALTER TABLE encuesta_log ADD CONSTRAINT encuesta_log_usuario_FK FOREIGN KEY ( usuario_encuesta_id ) REFERENCES encuesta_asignada ( id ) ;

ALTER TABLE encuesta ADD CONSTRAINT encuesta_usuario_FK FOREIGN KEY ( autor ) REFERENCES usuario ( id ) ;

ALTER TABLE evaluacion ADD CONSTRAINT evalua_parametros_evalua_FK FOREIGN KEY ( parametros_evalua_id ) REFERENCES parametros_evalua ( id ) ;

ALTER TABLE evaluacion ADD CONSTRAINT evalua_usuario_encuesta_FK FOREIGN KEY ( usuario_encuesta_id ) REFERENCES encuesta_asignada ( id ) ;
...
ALTER TABLE encuesta_asignada ADD CONSTRAINT usuario_encuesta_encuesta_FK FOREIGN KEY ( encuesta_id ) REFERENCES encuesta ( id ) ;

ALTER TABLE encuesta_asignada ADD CONSTRAINT usuario_encuesta_usuario_FK FOREIGN KEY ( usuario_id ) REFERENCES usuario ( id ) ;
...
CREATE SEQUENCE parametros_evalua_id_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER parametros_evalua_id_TRG BEFORE
  INSERT ON parametros_evalua FOR EACH ROW WHEN (NEW.id IS NULL) BEGIN :NEW.id := parametros_evalua_id_SEQ.NEXTVAL;
END;
/
...
CREATE SEQUENCE usuario_encuesta_detalle_id START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER usuario_encuesta_detalle_id BEFORE
  INSERT ON usuario_encuesta_detalle FOR EACH ROW WHEN (NEW.id IS NULL) BEGIN :NEW.id := usuario_encuesta_detalle_id.NEXTVAL;
END;
/
