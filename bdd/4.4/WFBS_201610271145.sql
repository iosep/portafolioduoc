...
IF FN_TOKEN(p_IDUSUARIO,p_TOKEN)=1 then
    ...
    SELECT COUNT(*) INTO total FROM ENCUESTA WHERE USUARIO_ID = p_USUARIOID AND PERIODO_ID = p_PERIODOID;
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12075157735877361)
,p_handler_id=>wwv_flow_api.id(12074691625870875)
,p_name=>'fecha'
...
wwv_flow_api.create_restful_param(
 p_id=>wwv_flow_api.id(12085307144938956)
,p_handler_id=>wwv_flow_api.id(12084734769926494)
,p_name=>'fecha'
,p_bind_variable_name=>'fecha'
,p_source_type=>'HEADER'
